...
export interface SoulCastGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    functionFragment: "PROPOSAL_THRESHOLD_TOKENS",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SoulCastGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): SoulCastGovernor;
  waitForDeployment(): Promise<this>;

  interface: SoulCastGovernorInterface;
  ...
  PROPOSAL_THRESHOLD_TOKENS: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "PROPOSAL_THRESHOLD_TOKENS"
  ...
  filters: {
    ...
    "ProposalCreatedWithType(uint256,uint8,string)": TypedContractEvent<
      ProposalCreatedWithTypeEvent.InputTuple,
      ProposalCreatedWithTypeEvent.OutputTuple,
      ProposalCreatedWithTypeEvent.OutputObject
    >;
